...
//#region node_modules/.nitro/vite/services/ssr/assets/_portal.multimedia.images._id-VgoSzYxC.js
var import_jsx_runtime = require_jsx_runtime();
var SplitNotFoundComponent = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	className: "mx-auto max-w-3xl px-6 py-24 text-center",
	children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image, { className: "mx-auto h-12 w-12 text-muted-foreground" }),
