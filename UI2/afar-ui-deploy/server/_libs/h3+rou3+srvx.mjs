...
/%(?:25)*(?:2f|5c)/i.source;
//#endregion
export { defineLazyEventHandler as a, serve as c, defineHandler as i, FastURL as l, HTTPError as n, toEventHandler as o, HTTPResponse as r, NodeResponse as s, H3Core as t };
